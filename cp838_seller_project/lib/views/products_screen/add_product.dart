...
class AddProduct extends StatelessWidget {
  ...
  AddProduct({Key? key, required this.data}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    //
    var controller = Get.put(ProductController());
    controller.categoryValue.value = data.toString();
    checkUpload() {
      Future.delayed(
    ...
    return bgWidget(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: 'Add product'.text.fontFamily(bold).white.make(),
        ),
        body: Obx(
